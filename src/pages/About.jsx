import { AboutSection, HeadingText, Team } from '../components';
    ...
    <section className="heading-style">
      ...
      {/* <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
        <div className="mx-auto mb-8 max-w-screen-sm lg:mb-16">
          ...
          <p className="hiw-text sm:text-xl">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus eum
            harum ullam, ipsum sunt provident, necessitatibus impedit obcaecati
            voluptates iure ducimus optio aspernatur. Reprehenderit suscipit
            praesentium, rerum quis exercitationem fugiat.
          </p>
        </div>

        <div className="grid gap-8 lg:gap-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          {team.map((member) => (
            <div className="text-center" key={member.id}>
              ...
              <ul className="flex justify-center mt-4 space-x-4">
                <li>
                  <h6 className="text-[#39569c] hover:text-gray-900 dark:hover:text-white">
                    <svg
                      className="w-6 h-6"
                      fill="currentColor"
                      viewBox="0 0 24 24"
