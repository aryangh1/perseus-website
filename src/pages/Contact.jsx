  ...
  return (
    <section>
      ...
      <div className="isolate px-6 lg:px-8">
        {/* <div
          className="absolute inset-x-0 top-[-10rem] -z-99 transform-gpu overflow-hidden blur-3xl sm:top-[-20rem]"
          aria-hidden="true"
        >
          <div
            className="-z-99 relative left-1/2 aspect-[600/678] w-[36.125rem] max-w-none -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:left-[calc(50%-40rem)] sm:w-[72.1875rem]"
            style={{
              clipPath:
